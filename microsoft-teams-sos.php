<?php
/**
 * AI Community Provider: Microsoft Teams SOS
 * 
 * Microsoft Teams tabanlı SOS doğrulama provider'ı
...
class AI_Community_Provider_Microsoft_Teams_SOS extends AI_Community_SOS_Provider {
    
    /**
     * Provider adı
     * @var string
     */
    protected $name = 'Microsoft Teams (SOS)';
    
    /**
     * Provider slug
     * @var string
     */
    public $slug = 'microsoft-teams-sos';
    
    /**
     * Provider rengi (Teams Mor-Mavisi)
     * @var string
     */
    protected $brand_color = '#464EB8';
    
    /**
     * İkincil renk
     * @var string
     */
    protected $secondary_color = '#7B83EB';
    ...
    public function get_status() {
        ...
        $status['tenant_configured'] = !empty($this->tenant_id);
    ...
    public function send_sms($phone, $code) {
        try {
            // Microsoft Teams temalı SMS mesajı
            $message = sprintf(
                "👋 Microsoft Teams Doğrulama Kodu: %s\n\n" .
                "Bu kod 10 dakika geçerlidir. Takımınız sizi bekliyor! 💼",
                $code
            );
    ...
    private function send_sms_vonage($phone, $message) {
        ...
        $from_number = $this->sms_config['from_number'] ?? 'Teams';
    ...
    public function handle_auth($request) {
        ...
        ob_start();
        ?>
        <div class="ai-community-sos-provider ai-community-sos-teams" style="--brand-color: <?php echo esc_attr($this->brand_color); ?>; --secondary-color: <?php echo esc_attr($this->secondary_color); ?>;">
            <div class="sos-header" style="background: linear-gradient(135deg, <?php echo esc_attr($this->brand_color); ?>, <?php echo esc_attr($this->secondary_color); ?>);">
                <div class="sos-brand">
                    <svg class="sos-logo" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M36 12C39.3137 12 42 14.6863 42 18C42 21.3137 39.3137 24 36 24C32.6863 24 30 21.3137 30 18C30 14.6863 32.6863 12 36 12Z" fill="white"/>
                        <path d="M24 6C27.3137 6 30 8.68629 30 12C30 15.3137 27.3137 18 24 18C20.6863 18 18 15.3137 18 12C18 8.68629 20.6863 6 24 6Z" fill="white"/>
                        <path d="M14 20C17.3137 20 20 22.6863 20 26C20 29.3137 17.3137 32 14 32C10.6863 32 8 29.3137 8 26C8 22.6863 10.6863 20 14 20Z" fill="white"/>
                        <path d="M36 24V36C36 39.3137 33.3137 42 30 42H18C14.6863 42 12 39.3137 12 36V24" stroke="white" stroke-width="3" fill="none"/>
                        <circle cx="32" cy="32" r="8" fill="<?php echo esc_attr($this->brand_color); ?>" stroke="white" stroke-width="2"/>
                        <path d="M29 32L31 34L35 30" stroke="white" stroke-width="2" stroke-linecap="round"/>
                    </svg>
                    <h2>Microsoft Teams ile Bağlan</h2>
                </div>
                <p class="sos-tagline">Takımınıza katılın! Telefon numaranız ile giriş yapın.</p>
            </div>
            ...
            <div class="sos-body">
                ...
                <div class="sos-info-box">
                    <h4>💼 Microsoft Teams ile:</h4>
                    <ul>
                        <li>📞 Sesli ve görüntülü toplantılar</li>
                        <li>💬 Takım sohbetleri ve kanallar</li>
                        <li>📁 Dosya paylaşımı ve işbirliği</li>
                        <li>📅 Ortak takvim ve planlama</li>
                    </ul>
                </div>
            </div>
        ...
        <style>
            ...
            .ai-community-sos-teams .sos-header {
                padding: 30px 24px;
                text-align: center;
                color: white;
            }
            
            .ai-community-sos-teams .sos-brand {
                display: flex;
            ...
            .ai-community-sos-teams .sos-logo {
                width: 64px;
                height: 64px;
                filter: drop-shadow(0 4px 8px rgba(0,0,0,0.2));
            }
            
            .ai-community-sos-teams .sos-brand h2 {
                margin: 0;
                font-size: 24px;
                font-weight: 600;
            }
            
            .ai-community-sos-teams .sos-tagline {
                margin: 10px 0 0;
                font-size: 14px;
                opacity: 0.9;
            }
            
            .ai-community-sos-teams .sos-body {
                padding: 30px 24px;
            }
            
            .ai-community-sos-teams .sos-field-group {
                margin-bottom: 25px;
            }
            
            .ai-community-sos-teams .sos-field-group label {
                display: block;
                margin-bottom: 8px;
                font-weight: 500;
                color: #2c3e50;
            ...
            .ai-community-sos-teams .sos-input-wrapper {
                position: relative;
                display: flex;
                align-items: center;
            }
            
            .ai-community-sos-teams .sos-input-icon {
                position: absolute;
                left: 12px;
                font-size: 18px;
            }
            
            .ai-community-sos-teams .sos-input-wrapper input {
                width: 100%;
            ...
            .ai-community-sos-teams .sos-input-wrapper input:focus {
                outline: none;
                border-color: var(--brand-color);
                box-shadow: 0 0 0 3px rgba(70, 78, 184, 0.1);
            }
            
            .ai-community-sos-teams .sos-field-group small {
                display: block;
                margin-top: 6px;
                color: #6c757d;
                font-size: 12px;
            ...
            .ai-community-sos-teams .sos-submit-btn {
                width: 100%;
                padding: 16px;
                border: none;
                border-radius: 12px;
            ...
            .ai-community-sos-teams .sos-submit-btn:hover {
                transform: translateY(-2px);
                box-shadow: 0 8px 20px rgba(70, 78, 184, 0.3);
            }
            
            .ai-community-sos-teams .sos-submit-btn:active {
                transform: translateY(0);
            }
            
            .ai-community-sos-teams .sos-info-box {
                margin-top: 30px;
                padding: 20px;
                background: #f8f9fa;
                border-radius: 12px;
            ...
            .ai-community-sos-teams .sos-info-box h4 {
                margin: 0 0 15px 0;
                color: #2c3e50;
                font-size: 16px;
            }
            
            .ai-community-sos-teams .sos-info-box ul {
                margin: 0;
                padding: 0;
                list-style: none;
            }
            
            .ai-community-sos-teams .sos-info-box li {
                padding: 8px 0;
                color: #495057;
                display: flex;
                align-items: center;
            ...
            .ai-community-sos-teams .sos-info-box li:before {
                content: "✓";
                color: var(--brand-color);
                font-weight: bold;
            }
            
            .ai-community-sos-teams .sos-footer {
                padding: 20px 24px;
                background: #f8f9fa;
            ...
            .ai-community-sos-teams .sos-footer p {
                margin: 0 0 10px 0;
                color: #6c757d;
                font-size: 12px;
            }
            
            .ai-community-sos-teams .sos-back-link {
                text-decoration: none;
                font-size: 14px;
                font-weight: 500;
            }
            
            .ai-community-sos-teams .sos-back-link:hover {
    ...
    protected function show_verification_form($phone) {
        ...
        <style>
            .ai-community-sos-teams .sos-resend {
                margin-top: 25px;
                text-align: center;
                padding-top: 20px;
                border-top: 1px solid #e9ecef;
            ...
            .ai-community-sos-teams .sos-resend p {
                margin: 0 0 10px 0;
                color: #6c757d;
                font-size: 14px;
            }
            
            .ai-community-sos-teams .sos-resend-btn {
                background: none;
                border: none;
                font-size: 14px;
                font-weight: 500;
            ...
            .ai-community-sos-teams .sos-resend-btn:hover {
                text-decoration: none;
            }
        </style>
        <?php
    ...
    protected function show_error($message) {
        ...
        <style>
            .ai-community-sos-teams .sos-error-box {
                background: #fef2f2;
            ...
            .ai-community-sos-teams .sos-error-icon {
                font-size: 24px;
            }
            
            .ai-community-sos-teams .sos-error-box p {
                margin: 0;
                color: #991b1b;
                font-size: 15px;
            }
            
            .ai-community-sos-teams .sos-actions {
                display: flex;
                flex-direction: column;
                gap: 15px;
                text-align: center;
            ...
            .ai-community-sos-teams .sos-retry-btn {
            ...
            .ai-community-sos-teams .sos-retry-btn:hover {
                transform: translateY(-2px);
                box-shadow: 0 4px 12px rgba(70, 78, 184, 0.3);
            }
            
            .ai-community-sos-teams .sos-alt-link {
                text-decoration: none;
                font-size: 14px;
            }
            
            .ai-community-sos-teams .sos-alt-link:hover {
                text-decoration: underline;
            }
        </style>
        <?php
