<?php
/**
 * AI Community Provider: Naver SOS
 * 
 * Naver tabanlı SOS doğrulama provider'ı
...
class AI_Community_Provider_Naver_SOS extends AI_Community_SOS_Provider {
    
    /**
     * Provider adı
     * @var string
     */
    protected $name = 'Naver (SOS)';
    
    /**
     * Provider slug
     * @var string
     */
    public $slug = 'naver-sos';
    
    /**
     * Provider rengi (Naver Yeşili)
     * @var string
     */
    protected $brand_color = '#03C75A';
    
    /**
     * İkincil renk
     * @var string
     */
    protected $secondary_color = '#1EC800';
    ...
    public function send_sms($phone, $code) {
        try {
            // Naver temalı SMS mesajı
            $message = sprintf(
                "🌱 Naver Doğrulama Kodu: %s\n\n" .
                "Bu kod 10 dakika geçerlidir. Naver'in tüm hizmetlerine hoş geldiniz! 🇰🇷",
                $code
            );
    ...
    public function handle_auth($request) {
        ...
        ob_start();
        ?>
        <div class="ai-community-sos-provider ai-community-sos-naver" style="--brand-color: <?php echo esc_attr($this->brand_color); ?>; --secondary-color: <?php echo esc_attr($this->secondary_color); ?>;">
            <div class="sos-header" style="background: linear-gradient(135deg, <?php echo esc_attr($this->brand_color); ?>, <?php echo esc_attr($this->secondary_color); ?>);">
                <div class="sos-brand">
                    <svg class="sos-logo" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M14 14V34H20L28 22V34H34V14H28L20 26V14H14Z" fill="<?php echo esc_attr($this->brand_color); ?>"/>
                    </svg>
                    <h2 style="color: white;">Naver ile Bağlan</h2>
                </div>
                <p class="sos-tagline" style="color: white;">Kore'nin en büyük portalı! Telefon numaran ile giriş yap.</p>
            </div>
            ...
            <div class="sos-body">
                ...
                <div class="sos-info-box">
                    <h4>🇰🇷 Naver hizmetleri:</h4>
                    <ul>
                        <li>🔍 Kore'nin 1 numaralı arama motoru</li>
                        <li>📧 Naver Mail ve Cafe</li>
                        <li>📰 Haberler ve bloglar</li>
                        <li>🎮 Naver Webtoon ve Oyunlar</li>
                    </ul>
                </div>
            </div>
        ...
        <style>
            ...
            .ai-community-sos-naver .sos-header {
                padding: 30px 24px;
                text-align: center;
                color: white;
            }
            
            .ai-community-sos-naver .sos-brand {
                display: flex;
            ...
            .ai-community-sos-naver .sos-logo {
                width: 64px;
                height: 64px;
                filter: drop-shadow(0 4px 8px rgba(0,0,0,0.2));
            }
            
            .ai-community-sos-naver .sos-brand h2 {
                margin: 0;
                font-size: 24px;
                font-weight: 600;
            }
            
            .ai-community-sos-naver .sos-tagline {
                margin: 10px 0 0;
                font-size: 14px;
                opacity: 0.9;
            }
            
            .ai-community-sos-naver .sos-body {
                padding: 30px 24px;
            }
            
            .ai-community-sos-naver .sos-field-group {
                margin-bottom: 25px;
            }
            
            .ai-community-sos-naver .sos-field-group label {
                display: block;
                margin-bottom: 8px;
                font-weight: 500;
                color: #2c3e50;
            ...
            .ai-community-sos-naver .sos-input-wrapper {
                position: relative;
                display: flex;
                align-items: center;
            }
            
            .ai-community-sos-naver .sos-input-icon {
                position: absolute;
                left: 12px;
                font-size: 18px;
            }
            
            .ai-community-sos-naver .sos-input-wrapper input {
                width: 100%;
            ...
            .ai-community-sos-naver .sos-input-wrapper input:focus {
                outline: none;
                border-color: var(--brand-color);
                box-shadow: 0 0 0 3px rgba(3, 199, 90, 0.1);
            }
            
            .ai-community-sos-naver .sos-field-group small {
                display: block;
                margin-top: 6px;
                color: #6c757d;
                font-size: 12px;
            ...
            .ai-community-sos-naver .sos-submit-btn {
                width: 100%;
                padding: 16px;
                border: none;
                border-radius: 12px;
            ...
            .ai-community-sos-naver .sos-submit-btn:hover {
                transform: translateY(-2px);
                box-shadow: 0 8px 20px rgba(3, 199, 90, 0.3);
            }
            
            .ai-community-sos-naver .sos-submit-btn:active {
                transform: translateY(0);
            }
            
            .ai-community-sos-naver .sos-info-box {
                margin-top: 30px;
                padding: 20px;
                background: #f8f9fa;
                border-radius: 12px;
            ...
            .ai-community-sos-naver .sos-info-box h4 {
                margin: 0 0 15px 0;
                color: #2c3e50;
                font-size: 16px;
            }
            
            .ai-community-sos-naver .sos-info-box ul {
                margin: 0;
                padding: 0;
                list-style: none;
            }
            
            .ai-community-sos-naver .sos-info-box li {
                padding: 8px 0;
                color: #495057;
                display: flex;
                align-items: center;
            ...
            .ai-community-sos-naver .sos-info-box li:before {
                content: "🌱";
            ...
            .ai-community-sos-naver .sos-footer {
                padding: 20px 24px;
                background: #f8f9fa;
            ...
            .ai-community-sos-naver .sos-footer p {
                margin: 0 0 10px 0;
                color: #6c757d;
                font-size: 12px;
            }
            
            .ai-community-sos-naver .sos-back-link {
                text-decoration: none;
                font-size: 14px;
                font-weight: 500;
            }
            
            .ai-community-sos-naver .sos-back-link:hover {
    ...
    protected function show_verification_form($phone) {
        ...
        <style>
            .ai-community-sos-naver .sos-resend {
                margin-top: 25px;
                text-align: center;
                padding-top: 20px;
                border-top: 1px solid #e9ecef;
            ...
            .ai-community-sos-naver .sos-resend p {
                margin: 0 0 10px 0;
                color: #6c757d;
                font-size: 14px;
            }
            
            .ai-community-sos-naver .sos-resend-btn {
                background: none;
                border: none;
                font-size: 14px;
                font-weight: 500;
            ...
            .ai-community-sos-naver .sos-resend-btn:hover {
                text-decoration: none;
            }
        </style>
        <?php
    ...
    protected function show_error($message) {
        ...
        <style>
            .ai-community-sos-naver .sos-error-box {
                background: #fef2f2;
            ...
            .ai-community-sos-naver .sos-error-icon {
                font-size: 24px;
            }
            
            .ai-community-sos-naver .sos-error-box p {
                margin: 0;
                color: #991b1b;
                font-size: 15px;
            }
            
            .ai-community-sos-naver .sos-actions {
                display: flex;
                flex-direction: column;
                gap: 15px;
                text-align: center;
            ...
            .ai-community-sos-naver .sos-retry-btn {
            ...
            .ai-community-sos-naver .sos-retry-btn:hover {
                transform: translateY(-2px);
                box-shadow: 0 4px 12px rgba(3, 199, 90, 0.3);
            }
            
            .ai-community-sos-naver .sos-alt-link {
                color: #6c757d;
                text-decoration: none;
                font-size: 14px;
            }
            
            .ai-community-sos-naver .sos-alt-link:hover {
                text-decoration: underline;
            }
        </style>
        <?php
    ...
    public function get_status() {
        ...
        $status['client_id_configured'] = !empty($this->client_id);
        $status['client_secret_configured'] = !empty($this->client_secret);
