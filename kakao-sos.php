<?php
/**
 * AI Community Provider: KakaoTalk SOS
 * 
 * KakaoTalk tabanlı SOS doğrulama provider'ı
...
class AI_Community_Provider_Kakao_SOS extends AI_Community_SOS_Provider {
    
    /**
     * Provider adı
     * @var string
     */
    protected $name = 'KakaoTalk (SOS)';
    
    /**
     * Provider slug
     * @var string
     */
    public $slug = 'kakao-sos';
    
    /**
     * Provider rengi (Kakao Sarısı)
     * @var string
     */
    protected $brand_color = '#FEE500';
    
    /**
     * İkincil renk (Kakao Kahverengisi)
     * @var string
     */
    protected $secondary_color = '#3A1D1D';
    ...
    public function __construct($id, $config, $core) {
        ...
        if (isset($config['rest_api_key'])) {
            $this->rest_api_key = $config['rest_api_key'];
        }
        
        if (isset($config['js_key'])) {
            $this->js_key = $config['js_key'];
        }
    }
    ...
    public function send_sms($phone, $code) {
        try {
            // KakaoTalk temalı SMS mesajı
            $message = sprintf(
                "🟡 KakaoTalk Doğrulama Kodu: %s\n\n" .
    ...
    public function handle_auth($request) {
        ...
        ob_start();
        ?>
        <div class="ai-community-sos-provider ai-community-sos-kakao" style="--brand-color: <?php echo esc_attr($this->brand_color); ?>; --secondary-color: <?php echo esc_attr($this->secondary_color); ?>;">
            <div class="sos-header" style="background-color: <?php echo esc_attr($this->brand_color); ?>;">
                <div class="sos-brand">
                    <svg class="sos-logo" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="24" cy="24" r="20" fill="<?php echo esc_attr($this->secondary_color); ?>"/>
                        <path d="M24 10C16.5 10 10 15.5 10 22C10 26.5 13 30.5 17.5 32.5L16 38L22 34C22.5 34 23.5 34 24 34C31.5 34 38 28.5 38 22C38 15.5 31.5 10 24 10Z" fill="white"/>
                        <text x="14" y="28" font-family="Arial" font-size="14" font-weight="bold" fill="<?php echo esc_attr($this->secondary_color); ?>">Kakao</text>
                        <text x="22" y="38" font-family="Arial" font-size="10" fill="<?php echo esc_attr($this->secondary_color); ?>">Talk</text>
                    </svg>
                    <h2 style="color: <?php echo esc_attr($this->secondary_color); ?>;">KakaoTalk ile Bağlan</h2>
                </div>
                <p class="sos-tagline" style="color: <?php echo esc_attr($this->secondary_color); ?>;">Kore'nin en popüler mesajlaşma uygulaması! Telefon numaran ile giriş yap.</p>
            </div>
            ...
            <div class="sos-body">
                <form method="post" action="" class="sos-form">
                    ...
                    <button type="submit" class="sos-submit-btn" style="background-color: <?php echo esc_attr($this->brand_color); ?>; color: <?php echo esc_attr($this->secondary_color); ?>;">
                        <span>🟡 Doğrulama Kodu Gönder</span>
                    </button>
                </form>
                
                <div class="sos-info-box">
                    <h4 style="color: <?php echo esc_attr($this->secondary_color); ?>;">🟡 KakaoTalk'da bizi takip edin:</h4>
                    <ul>
                        <li>🗨️ Ücretsiz mesajlaşma ve aramalar</li>
                        <li>🎭 Eğlenceli emojiler ve KakaoFriends</li>
                        <li>👥 Grup sohbetleri (1.500 kişiye kadar)</li>
                        <li>💰 KakaoPay ve KakaoStore</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="sos-footer">
                ...
                <a href="<?php echo esc_url(home_url('/login')); ?>" class="sos-back-link" style="color: <?php echo esc_attr($this->secondary_color); ?>;">← Diğer giriş yöntemleri</a>
            </div>
        </div>
        
        <style>
            .ai-community-sos-kakao {
                max-width: 480px;
                margin: 0 auto;
                background: white;
                border-radius: 16px;
            ...
            .ai-community-sos-kakao .sos-header {
                padding: 30px 24px;
                text-align: center;
                color: <?php echo esc_attr($this->secondary_color); ?>;
            }
            
            .ai-community-sos-kakao .sos-brand {
                display: flex;
            ...
            .ai-community-sos-kakao .sos-logo {
                width: 64px;
                height: 64px;
                filter: drop-shadow(0 4px 8px rgba(0,0,0,0.1));
            }
            
            .ai-community-sos-kakao .sos-brand h2 {
                margin: 0;
                font-size: 24px;
                font-weight: 600;
            }
            
            .ai-community-sos-kakao .sos-tagline {
                margin: 10px 0 0;
                font-size: 14px;
                opacity: 0.8;
            }
            
            .ai-community-sos-kakao .sos-body {
                padding: 30px 24px;
            }
            
            .ai-community-sos-kakao .sos-field-group {
                margin-bottom: 25px;
            }
            
            .ai-community-sos-kakao .sos-field-group label {
                display: block;
                margin-bottom: 8px;
                font-weight: 500;
                color: #2c3e50;
            ...
            .ai-community-sos-kakao .sos-input-wrapper {
                position: relative;
                display: flex;
                align-items: center;
            }
            
            .ai-community-sos-kakao .sos-input-icon {
                position: absolute;
                left: 12px;
                font-size: 18px;
            }
            
            .ai-community-sos-kakao .sos-input-wrapper input {
                width: 100%;
            ...
            .ai-community-sos-kakao .sos-input-wrapper input:focus {
                outline: none;
                border-color: var(--brand-color);
                box-shadow: 0 0 0 3px rgba(254, 229, 0, 0.2);
            }
            
            .ai-community-sos-kakao .sos-field-group small {
                display: block;
                margin-top: 6px;
                color: #6c757d;
                font-size: 12px;
            ...
            .ai-community-sos-kakao .sos-submit-btn {
                width: 100%;
                padding: 16px;
                border: none;
                border-radius: 12px;
            ...
            .ai-community-sos-kakao .sos-submit-btn:hover {
                transform: translateY(-2px);
                box-shadow: 0 8px 20px rgba(254, 229, 0, 0.4);
            }
            
            .ai-community-sos-kakao .sos-submit-btn:active {
                transform: translateY(0);
            }
            
            .ai-community-sos-kakao .sos-info-box {
                margin-top: 30px;
                padding: 20px;
                background: #f8f9fa;
                border-radius: 12px;
            ...
            .ai-community-sos-kakao .sos-info-box h4 {
                margin: 0 0 15px 0;
                font-size: 16px;
            }
            
            .ai-community-sos-kakao .sos-info-box ul {
                margin: 0;
                padding: 0;
                list-style: none;
            }
            
            .ai-community-sos-kakao .sos-info-box li {
                padding: 8px 0;
                color: #495057;
                display: flex;
                align-items: center;
            ...
            .ai-community-sos-kakao .sos-info-box li:before {
                content: "🟡";
                font-weight: bold;
                margin-right: 8px;
            }
            
            .ai-community-sos-kakao .sos-footer {
                padding: 20px 24px;
                background: #f8f9fa;
            ...
            .ai-community-sos-kakao .sos-footer p {
                margin: 0 0 10px 0;
                color: #6c757d;
                font-size: 12px;
            }
            
            .ai-community-sos-kakao .sos-back-link {
                text-decoration: none;
                font-size: 14px;
                font-weight: 500;
            }
            
            .ai-community-sos-kakao .sos-back-link:hover {
    ...
    protected function show_verification_form($phone) {
        ...
        <div class="ai-community-sos-provider ai-community-sos-kakao" style="--brand-color: <?php echo esc_attr($this->brand_color); ?>; --secondary-color: <?php echo esc_attr($this->secondary_color); ?>;">
            <div class="sos-header" style="background-color: <?php echo esc_attr($this->brand_color); ?>;">
                <div class="sos-brand">
                    ...
                    <h2 style="color: <?php echo esc_attr($this->secondary_color); ?>;">Doğrulama Kodu</h2>
                </div>
                <p class="sos-tagline" style="color: <?php echo esc_attr($this->secondary_color); ?>;"><?php echo esc_html($phone); ?> numarasına kod gönderildi</p>
            </div>
                ...
                <div class="sos-resend">
                    ...
                    <form method="post" action="" class="sos-resend-form">
                        ...
                        <?php if ($redirect_to): ?>
                            <input type="hidden" name="redirect_to" value="<?php echo esc_attr($redirect_to); ?>">
                        <?php endif; ?>
                        <button type="submit" class="sos-resend-btn" style="color: <?php echo esc_attr($this->secondary_color); ?>;">
                            🔄 Tekrar gönder
                        </button>
                    </form>
                </div>
            ...
            <div class="sos-footer">
                <a href="<?php echo esc_url(add_query_arg(['sos_provider' => $this->slug], home_url('/login'))); ?>" class="sos-back-link" style="color: <?php echo esc_attr($this->secondary_color); ?>;">
        ...
        <style>
            .ai-community-sos-kakao .sos-resend {
                margin-top: 25px;
                text-align: center;
                padding-top: 20px;
                border-top: 1px solid #e9ecef;
            ...
            .ai-community-sos-kakao .sos-resend p {
                margin: 0 0 10px 0;
                color: #6c757d;
                font-size: 14px;
            }
            
            .ai-community-sos-kakao .sos-resend-btn {
                background: none;
                border: none;
                font-size: 14px;
                font-weight: 500;
            ...
            .ai-community-sos-kakao .sos-resend-btn:hover {
                text-decoration: none;
            }
        </style>
        <?php
    ...
    protected function show_error($message) {
        ...
        <div class="ai-community-sos-provider ai-community-sos-kakao" style="--brand-color: <?php echo esc_attr($this->brand_color); ?>; --secondary-color: <?php echo esc_attr($this->secondary_color); ?>;">
            <div class="sos-header" style="background-color: <?php echo esc_attr($this->brand_color); ?>;">
                <div class="sos-brand">
                    ...
                    <h2 style="color: <?php echo esc_attr($this->secondary_color); ?>;">Hata Oluştu</h2>
                </div>
            </div>
            ...
            <div class="sos-body">
                ...
                <div class="sos-actions">
                    <a href="<?php echo esc_url(add_query_arg(['sos_provider' => $this->slug], home_url('/login'))); ?>" class="sos-retry-btn" style="background-color: <?php echo esc_attr($this->brand_color); ?>; color: <?php echo esc_attr($this->secondary_color); ?>;">
                        🔄 Tekrar Dene
                    </a>
        ...
        <style>
            .ai-community-sos-kakao .sos-error-box {
                background: #fef2f2;
            ...
            .ai-community-sos-kakao .sos-error-icon {
                font-size: 24px;
            }
            
            .ai-community-sos-kakao .sos-error-box p {
                margin: 0;
                color: #991b1b;
                font-size: 15px;
            }
            
            .ai-community-sos-kakao .sos-actions {
                display: flex;
                flex-direction: column;
                gap: 15px;
                text-align: center;
            ...
            .ai-community-sos-kakao .sos-retry-btn {
            ...
            .ai-community-sos-kakao .sos-retry-btn:hover {
                transform: translateY(-2px);
                box-shadow: 0 4px 12px rgba(254, 229, 0, 0.4);
            }
            
            .ai-community-sos-kakao .sos-alt-link {
                color: #6c757d;
                text-decoration: none;
                font-size: 14px;
            }
            
            .ai-community-sos-kakao .sos-alt-link:hover {
                text-decoration: underline;
            }
        </style>
        <?php
    ...
    public function get_status() {
        ...
        $status['rest_api_key_configured'] = !empty($this->rest_api_key);
        $status['js_key_configured'] = !empty($this->js_key);
