<?php
/**
 * AI Community Provider: iQiyi (爱奇艺)
 * 
...
/**
 * iQiyi OAuth Provider sınıfı
 */
class AI_Community_Provider_Iqiyi extends AI_Community_OAuth2_Provider {
     ...
     * @var string
     */
    protected $auth_url = 'https://openapi.iqiyi.com/oauth/authorize';
     ...
     * @var string
     */
    protected $token_url = 'https://openapi.iqiyi.com/oauth/token';
     ...
     * @var string
     */
    protected $userinfo_url = 'https://openapi.iqiyi.com/api/user/info';
    ...
    /**
     * Token yanıtından openid'yi çıkar (iQiyi özel)
     *
     * @param array $response Token yanıtı
    ...
    public function map_userinfo_to_profile($userinfo) {
        ...
        // iQiyi API yanıt yapısına göre mapping
        ...
        if (isset($data['vip_type'])) {
            $profile['vip_type'] = $data['vip_type'];
        }
    ...
    protected function handle_callback($request) {
        ...
        // Token yanıtından openid'yi çek (iQiyi özel)
