<?php
/**
 * AI Community Provider: Snapchat SOS
 * 
 * Snapchat tabanlı SOS doğrulama provider'ı
...
class AI_Community_Provider_Snapchat_SOS extends AI_Community_SOS_Provider {
    
    /**
     * Provider adı
     * @var string
     */
    protected $name = 'Snapchat (SOS)';
    
    /**
     * Provider slug
     * @var string
     */
    public $slug = 'snapchat-sos';
    
    /**
     * Provider rengi (Snapchat Sarısı)
     * @var string
     */
    protected $brand_color = '#FFFC00';
    ...
    public function send_sms($phone, $code) {
        try {
            // Snapchat temalı SMS mesajı
            $message = sprintf(
                "👻 Snapchat Doğrulama Kodu: %s\n\n" .
                "Bu kod 10 dakika geçerlidir. Haydi snap at! 📸",
                $code
            );
    ...
    public function handle_auth($request) {
        ...
        ob_start();
        ?>
        <div class="ai-community-sos-provider ai-community-sos-snapchat" style="--brand-color: <?php echo esc_attr($this->brand_color); ?>;">
            <div class="sos-header" style="background-color: <?php echo esc_attr($this->brand_color); ?>;">
                <div class="sos-brand">
                    <svg class="sos-logo" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M24 4C14.0589 4 6 12.0589 6 22C6 26.5 8.5 33.5 16 36.5C16 37.5 16.5 39.5 18 40.5C19.5 41.5 21 41 22 41C23 41 24 41.5 24 43C24 44.5 22.5 44 22.5 44H25.5C25.5 44 24 44.5 24 43C24 41.5 25 41 26 41C27 41 28.5 41.5 30 40.5C31.5 39.5 32 37.5 32 36.5C39.5 33.5 42 26.5 42 22C42 12.0589 33.9411 4 24 4Z" fill="white" stroke="black" stroke-width="2"/>
                        <circle cx="18" cy="20" r="3" fill="black"/>
                        <circle cx="30" cy="20" r="3" fill="black"/>
                        <path d="M20 28C22 30 26 30 28 28" stroke="black" stroke-width="2" stroke-linecap="round"/>
                    </svg>
                    <h2 style="color: #000;">Snapchat ile Bağlan</h2>
                </div>
                <p class="sos-tagline" style="color: #000;">Arkadaşlarınla snap at! Telefon numaran ile giriş yap.</p>
            </div>
            ...
            <div class="sos-body">
                <form method="post" action="" class="sos-form">
                    ...
                    <button type="submit" class="sos-submit-btn" style="background-color: <?php echo esc_attr($this->brand_color); ?>; color: #000;">
                        <span>📸 Doğrulama Kodu Gönder</span>
                    </button>
                </form>
                
                <div class="sos-info-box">
                    <h4>👻 Snapchat'te bizi takip edin:</h4>
                    <ul>
                        <li>📸 Günlük snap'ler</li>
                        <li>🎭 Filtreler ve lensler</li>
                        <li>📍 Snap Map'te konumumuz</li>
                        <li>🔥 Streak'ler ve arkadaşlıklar</li>
                    </ul>
                </div>
            </div>
        ...
        <style>
            ...
            .ai-community-sos-snapchat .sos-header {
                padding: 30px 24px;
                text-align: center;
                color: #000;
            }
            
            .ai-community-sos-snapchat .sos-brand {
                display: flex;
            ...
            .ai-community-sos-snapchat .sos-logo {
                width: 64px;
                height: 64px;
                filter: drop-shadow(0 4px 8px rgba(0,0,0,0.1));
            }
            
            .ai-community-sos-snapchat .sos-brand h2 {
                margin: 0;
                font-size: 24px;
                font-weight: 600;
            }
            
            .ai-community-sos-snapchat .sos-tagline {
                margin: 10px 0 0;
                font-size: 14px;
                opacity: 0.8;
            }
            
            .ai-community-sos-snapchat .sos-body {
                padding: 30px 24px;
            }
            
            .ai-community-sos-snapchat .sos-field-group {
                margin-bottom: 25px;
            }
            
            .ai-community-sos-snapchat .sos-field-group label {
                display: block;
                margin-bottom: 8px;
                font-weight: 500;
                color: #2c3e50;
            ...
            .ai-community-sos-snapchat .sos-input-wrapper {
                position: relative;
                display: flex;
                align-items: center;
            }
            
            .ai-community-sos-snapchat .sos-input-icon {
                position: absolute;
                left: 12px;
                font-size: 18px;
            }
            
            .ai-community-sos-snapchat .sos-input-wrapper input {
                width: 100%;
            ...
            .ai-community-sos-snapchat .sos-input-wrapper input:focus {
                outline: none;
                border-color: var(--brand-color);
                box-shadow: 0 0 0 3px rgba(255, 252, 0, 0.2);
            }
            
            .ai-community-sos-snapchat .sos-field-group small {
                display: block;
                margin-top: 6px;
                color: #6c757d;
                font-size: 12px;
            ...
            .ai-community-sos-snapchat .sos-submit-btn {
                width: 100%;
                padding: 16px;
                border: none;
                border-radius: 12px;
            ...
            .ai-community-sos-snapchat .sos-submit-btn:hover {
                transform: translateY(-2px);
                box-shadow: 0 8px 20px rgba(255, 252, 0, 0.4);
            }
            
            .ai-community-sos-snapchat .sos-submit-btn:active {
                transform: translateY(0);
            }
            
            .ai-community-sos-snapchat .sos-info-box {
                margin-top: 30px;
                padding: 20px;
                background: #f8f9fa;
                border-radius: 12px;
            ...
            .ai-community-sos-snapchat .sos-info-box h4 {
                margin: 0 0 15px 0;
                color: #2c3e50;
                font-size: 16px;
            }
            
            .ai-community-sos-snapchat .sos-info-box ul {
                margin: 0;
                padding: 0;
                list-style: none;
            }
            
            .ai-community-sos-snapchat .sos-info-box li {
                padding: 8px 0;
                color: #495057;
                display: flex;
                align-items: center;
            ...
            .ai-community-sos-snapchat .sos-info-box li:before {
                content: "👻";
            ...
            .ai-community-sos-snapchat .sos-footer {
                padding: 20px 24px;
                background: #f8f9fa;
            ...
            .ai-community-sos-snapchat .sos-footer p {
                margin: 0 0 10px 0;
                color: #6c757d;
                font-size: 12px;
            }
            
            .ai-community-sos-snapchat .sos-back-link {
                text-decoration: none;
                font-size: 14px;
                font-weight: 500;
            }
            
            .ai-community-sos-snapchat .sos-back-link:hover {
    ...
    protected function show_verification_form($phone) {
        ...
        <div class="ai-community-sos-provider ai-community-sos-snapchat" style="--brand-color: <?php echo esc_attr($this->brand_color); ?>;">
            <div class="sos-header" style="background-color: <?php echo esc_attr($this->brand_color); ?>;">
                <div class="sos-brand">
                    ...
                    <h2 style="color: #000;">Doğrulama Kodu</h2>
                </div>
                <p class="sos-tagline" style="color: #000;"><?php echo esc_html($phone); ?> numarasına kod gönderildi</p>
            </div>
        ...
        <style>
            .ai-community-sos-snapchat .sos-resend {
                margin-top: 25px;
                text-align: center;
                padding-top: 20px;
                border-top: 1px solid #e9ecef;
            ...
            .ai-community-sos-snapchat .sos-resend p {
                margin: 0 0 10px 0;
                color: #6c757d;
                font-size: 14px;
            }
            
            .ai-community-sos-snapchat .sos-resend-btn {
                background: none;
                border: none;
                font-size: 14px;
                font-weight: 500;
            ...
            .ai-community-sos-snapchat .sos-resend-btn:hover {
                text-decoration: none;
            }
        </style>
        <?php
    ...
    protected function show_error($message) {
        ...
        <div class="ai-community-sos-provider ai-community-sos-snapchat" style="--brand-color: <?php echo esc_attr($this->brand_color); ?>;">
            <div class="sos-header" style="background-color: <?php echo esc_attr($this->brand_color); ?>;">
                <div class="sos-brand">
                    ...
                    <h2 style="color: #000;">Hata Oluştu</h2>
                </div>
            </div>
            ...
            <div class="sos-body">
                ...
                <div class="sos-actions">
                    <a href="<?php echo esc_url(add_query_arg(['sos_provider' => $this->slug], home_url('/login'))); ?>" class="sos-retry-btn" style="background-color: <?php echo esc_attr($this->brand_color); ?>; color: #000;">
                        🔄 Tekrar Dene
                    </a>
        ...
        <style>
            .ai-community-sos-snapchat .sos-error-box {
                background: #fef2f2;
            ...
            .ai-community-sos-snapchat .sos-error-icon {
                font-size: 24px;
            }
            
            .ai-community-sos-snapchat .sos-error-box p {
                margin: 0;
                color: #991b1b;
                font-size: 15px;
            }
            
            .ai-community-sos-snapchat .sos-actions {
                display: flex;
                flex-direction: column;
                gap: 15px;
                text-align: center;
            ...
            .ai-community-sos-snapchat .sos-retry-btn {
            ...
            .ai-community-sos-snapchat .sos-retry-btn:hover {
                transform: translateY(-2px);
                box-shadow: 0 4px 12px rgba(255, 252, 0, 0.4);
            }
            
            .ai-community-sos-snapchat .sos-alt-link {
                color: #6c757d;
                text-decoration: none;
                font-size: 14px;
            }
            
            .ai-community-sos-snapchat .sos-alt-link:hover {
                text-decoration: underline;
            }
        </style>
        <?php
